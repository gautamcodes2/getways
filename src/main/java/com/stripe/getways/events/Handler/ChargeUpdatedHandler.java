...
@Component
public class ChargeUpdatedHandler implements StripeEventHandler {
    ...
    public ChargeUpdatedHandler(PaymentSessionRepositoryService paymentSessionRepositoryService, BalanceTransactionRepositoryService balanceTransactionRepositoryService) {
