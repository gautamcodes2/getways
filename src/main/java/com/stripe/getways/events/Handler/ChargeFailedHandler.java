...
@Component
public class ChargeFailedHandler implements StripeEventHandler {
    ...
    public ChargeFailedHandler(PaymentSessionRepositoryService paymentSessionRepositoryService, BalanceTransactionRepositoryService balanceTransactionRepositoryService) {
